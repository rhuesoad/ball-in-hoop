function run = T2_tracking_inner_5deg_1hz()
%T2_TRACKING_INNER_5DEG_1HZ  LQR tracks a 5 deg / 1 Hz sinusoid, inner hoop.
...
%   this radius.
    ...
    scn.id   = 'T2_tracking_inner_5deg_1hz';
    scn.name = 'T2 - Sine 5 deg at 1 Hz (inner)';
